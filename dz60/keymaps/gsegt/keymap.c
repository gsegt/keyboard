...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  LAYOUT_60_ansi_split_bs_rshift(
    ...
    KC_GRAVE,           KC_A,     KC_S,     KC_D,     KC_F,     KC_G,     KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,  SC_SENT,
  ...
  LAYOUT_60_ansi_split_bs_rshift(
    ...
    _______,            _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  KC_VOLU,  KC_PSCR,  KC_F15,   KC_F16,   KC_F17,
    _______,            _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  KC_VOLD,  _______,  _______,  _______,
    _______,            _______,  _______,  _______,  _______,  _______,  NK_TOGG,  KC_MUTE,  KC_MPRV,  KC_MNXT,  _______,            KC_PGUP,  _______,
